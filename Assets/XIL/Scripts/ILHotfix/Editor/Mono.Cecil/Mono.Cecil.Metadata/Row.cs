...
namespace MonoIL.Cecil.Metadata {

    struct Row2Str
    {
        internal string Col1;
        internal string Col2;

        public Row2Str(string col1, string col2)
        {
            Col1 = col1;
            Col2 = col2;
        }
    ...
    struct Row2UInt
    {
        ...
        public Row2UInt(uint col1, uint col2)
        {
            Col1 = col1;
            Col2 = col2;
        }
    ...
    struct Row3UInt
    {
        ...
        public Row3UInt(uint col1, uint col2, uint col3)
        {
            Col1 = col1;
            Col2 = col2;
            Col3 = col3;
    ...
    sealed class RowEqualityComparer : IEqualityComparer<Row2Str>, IEqualityComparer<Row2UInt>, IEqualityComparer<Row3UInt>
    {

        public bool Equals(Row2Str x, Row2Str y)
        {
            return x.Col1 == y.Col1
                && x.Col2 == y.Col2;
        }

        public int GetHashCode(Row2Str obj)
        {
            string x = obj.Col1, y = obj.Col2;
            return (x != null ? x.GetHashCode() : 0) ^ (y != null ? y.GetHashCode() : 0);
        }

        public bool Equals(Row2UInt x, Row2UInt y)
        {
            return x.Col1 == y.Col1
                && x.Col2 == y.Col2;
        }

        public int GetHashCode(Row2UInt obj)
        {
            return (int)(obj.Col1 ^ obj.Col2);
        }

        public bool Equals(Row3UInt x, Row3UInt y)
        {
            return x.Col1 == y.Col1
                && x.Col2 == y.Col2
                && x.Col3 == y.Col3;
        ...
        public int GetHashCode(Row3UInt obj)
        {
