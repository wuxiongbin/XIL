...
namespace wxb
{
    public static class L
    {
        ...
        class UnityLog : I
        {
            ...
            {
                UnityEngine.Debug.Log(string.Format(format, objs));
            }
            void I.LogWarningFormat(string format, params object[] objs)
            {
                UnityEngine.Debug.LogWarning(string.Format(format, objs));
            }
            ...
            {
                UnityEngine.Debug.LogError(string.Format(format, objs));
            }
