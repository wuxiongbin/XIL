...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Collider_Binding
    {
        ...
        static StackObject* set_sharedMaterial_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.PhysicMaterial @value = (UnityEngine.PhysicMaterial)typeof(UnityEngine.PhysicMaterial).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
