...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_UIBehaviour_Binding
    {
        ...
        static StackObject* IsActive_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.UIBehaviour instance_of_this_method = (UnityEngine.EventSystems.UIBehaviour)typeof(UnityEngine.EventSystems.UIBehaviour).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
