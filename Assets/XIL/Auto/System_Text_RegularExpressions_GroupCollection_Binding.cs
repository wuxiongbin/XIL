...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Text_RegularExpressions_GroupCollection_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_SyncRoot_5);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new System.Text.RegularExpressions.GroupCollection[s]);
        ...
        static StackObject* get_SyncRoot_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
